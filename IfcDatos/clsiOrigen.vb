...
Public Class iOrigen
    ...
    Public Function escribir(ByVal pOrigenid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String, ByVal pOrgnidan As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "I"
            ejecutar(2, pOrigenid, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod, pOrgnidan)
    ...
    Public Function actualizar(ByVal pOrigenid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String, ByVal pOrgnidan As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "U"

            ejecutar(3, pOrigenid, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod, pOrgnidan)
    ...
    Public Function leer(ByVal pOrigenid As String) As DataTable
        Dim resultados As DataTable = Nothing
        ...
        Try
            ...
            stipoExpr = "S"
            resultados = ejecutar(4, pOrigenid, "", 0, "", "", "", "", "")


            If Not resultados Is Nothing Then
                If resultados.Rows.Count = 0 Then Throw New Exception("No se encontró el registro " + pOrigenid + ".")
            End If
        Catch ex As Exception
    ...
    Public Function origenAnterior(ByVal pOrigenid As String) As String
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(5, pOrigenid, "", 0, "", "", "", "", "")

            gen3E = New Genericas3E
            No = gen3E.valorCampo(resultados, 0, "OrigenId")
        Catch ex As Exception
    ...
    Public Function origenSiguiente(ByVal pOrigenid As String) As String
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(6, pOrigenid, "", 0, "", "", "", "", "")
    ...
    Private Function ejecutar(ByVal pOpcion As Integer, ByVal pOrigenid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String, ByVal pOrgnidan As String) As DataTable
        ...
        Try
            ...
            consulta = "exec [PA_sOrigen] " + pOpcion.ToString + ", '" + pOrigenid + "', '" + pNombre + "', " + pActivo.ToString + ", '" + pFchcrea + "', '" + pUsrcrea + "', '" + pFchmod + "', '" + pUsrmod + "', '" + pOrgnidan + "'"
