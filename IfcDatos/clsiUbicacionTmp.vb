...
Public Class iUbicacionTmp
    ...
    Public Function escribir(ByVal pUbcTmpId As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "I"
            ejecutar(2, pUbcTmpId, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod)
    ...
    Public Function actualizar(ByVal pUbcTmpId As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "U"

            ejecutar(3, pUbcTmpId, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod)
    ...
    Public Function leer(ByVal pUbcTmpId As String) As DataTable
        Dim resultados As DataTable = Nothing
        ...
        Try
            ...
            stipoExpr = "S"
            resultados = ejecutar(4, pUbcTmpId, "", 0, "", "", "", "")


            If Not resultados Is Nothing Then
                If resultados.Rows.Count = 0 Then Throw New Exception("No se encontró el registro " + pUbcTmpId + ".")
            End If
        Catch ex As Exception
    ...
    Public Function ubicacionAnterior(ByVal pUbcTmpId As String) As String
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(5, pUbcTmpId, "", 0, "", "", "", "")

            gen3E = New Genericas3E
            No = gen3E.valorCampo(resultados, 0, "UbicaId")
        Catch ex As Exception
            msg.setError("No fue posible obtener la Ubicación Temporal anterior al actual: " + ex.Message)
        End Try
    ...
    Public Function ubicacionSiguiente(ByVal pUbcTmpId As String) As String
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(6, pUbcTmpId, "", 0, "", "", "", "")

            gen3E = New Genericas3E
            No = gen3E.valorCampo(resultados, 0, "UbicaId")
        Catch ex As Exception
            msg.setError("No fue posible obtener el Ubicación Temporal siguiente al actual: " + ex.Message)
        End Try
    ...
    Public Function cerrarConexion() As Mensaje
        ...
        Return msg
    End Function
    Private Function ejecutar(ByVal pOpcion As Integer, ByVal pUbcTmpId As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As DataTable
        ...
        Try
            ...
            consulta = "exec [PA_sUbicacionTmp] " + pOpcion.ToString + ", '" + pUbcTmpId + "', '" + pNombre + "', " + pActivo.ToString + ", '" + pFchcrea + "', '" + pUsrcrea + "', '" + pFchmod + "', '" + pUsrmod + "'"
