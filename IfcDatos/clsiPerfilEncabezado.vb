...
Public Class iPerfilEncabezado
    ...
    Public Function escribir(ByVal pPerfilid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "I"
            ejecutar(2, pPerfilid, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod)
        Catch ex As Exception
    ...
    Public Function actualizar(ByVal pPerfilid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As Mensaje
        Try
            msg.reset()

            stipoExpr = "U"

            ejecutar(3, pPerfilid, pNombre, pActivo, pFchcrea, pUsrcrea, pFchmod, pUsrmod)
    ...
    Public Function leer(ByVal pPerfilid As String) As DataTable
        ...
        Try
            ...
            stipoExpr = "S"
            resultados = ejecutar(4, pPerfilid, "", 0, "", "", "", "")


            If Not resultados Is Nothing Then
                If resultados.Rows.Count = 0 Then Throw New Exception("No se encontró el Perfil " + pPerfilid + ".")
            End If
        Catch ex As Exception
    ...
    Public Function perfilAnterior(ByVal pPerfilid As String) As String
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(5, pPerfilid, "", 0, "", "", "", "")

            gen3E = New Genericas3E
            No = gen3E.valorCampo(resultados, 0, "PerfilId")
        Catch ex As Exception
    ...
    Public Function perfilSiguiente(ByVal pPerfilid As String) As String
        Dim No As String = "-1000"
        Dim resultados As DataTable = Nothing
        Dim gen3E As Genericas3E = Nothing
        ...
        Try
            stipoExpr = "S"
            resultados = ejecutar(6, pPerfilid, "", 0, "", "", "", "")
    ...
    Private Function ejecutar(ByVal pOpcion As Integer, ByVal pPerfilid As String, ByVal pNombre As String, ByVal pActivo As Integer, ByVal pFchcrea As String, ByVal pUsrcrea As String, ByVal pFchmod As String, ByVal pUsrmod As String) As DataTable
        ...
        Try
            ...
            consulta = "exec [PA_sPrfls1] " + pOpcion.ToString + ", '" + pPerfilid + "', '" + pNombre + "', " + pActivo.ToString + ", '" + pFchcrea + "', '" + pUsrcrea + "', '" + pFchmod + "', '" + pUsrmod + "'"
